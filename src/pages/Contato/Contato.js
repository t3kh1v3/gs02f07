...
const InvestorDashboardContent = () => {
    return (
    <div>
        <div className='investor-title'><h1>Gráficos destinados para <span>Investidores</span></h1></div>
...
export const ONGsDashboardContent = () => {
    return (
<div>
    <div className='ong-title'><h1>Gráficos destinados para as <span>ONGs</span></h1></div>
...
<div>
    <div className='community-title'><h1>Gráfico destinado para a <span>Comunidade</span></h1></div>
